...
public class BankTest {
    ...
    public void setUp() throws Exception {
        b = new Bank();
        b.createAccount("Adam",100.0f,0.0001f);
    ...
    public void testCreateAccount(){
        assertEquals("Adam",b.get("Adam").holder);
    ...
    public void testCreditInterest(){
        advance30days();
        b.creditInterest();
        assertEquals(100.3f,b.get("Adam").balance,DELTA);
        assertEquals(0f,b.get("Adam").interestEarned,DELTA);
        assertEquals(b.today.toString(),b.get("Adam").dayLastOp.toString());
    }
