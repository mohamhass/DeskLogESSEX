...
public class BankAccount {
    ...
    public BankAccount(float initialBalance, int dayCreated, float rate) {
        ...
        this.dayLastOp = dayCreated;
        this.interestEarned = 0.0f;
        this.interestRate = rate;
    }

    public BankAccount(String accountHolder, int accountNumber, float v, LocalDate localDate, float v1) {
    }
    ...
    private static void test_creation() {
        ...
        assert a.interestRate == 31 : "Incorrect day last operation!";
        assert a.dayLastOp == 0.0001f : "Incorrect interest rate!";
    }
    ...
    public static void main(String[] args) {
        ...
        /*
        Create the test then deposit then withdraw then credit.
         */
    }

    void updateEarnedInterest(LocalDate today) {
